...
//   it("receive accepts narrow source, derived, and plain transmitters independently", () => {
...
//   it("transmit broadcasts narrow source, derived, and plain values to wide receivers", () => {
//     const narrowSource = signal<NarrowObject>({
//       title: "source",
//       isSelected: true,
//     });
